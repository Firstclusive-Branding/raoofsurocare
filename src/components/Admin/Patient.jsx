...
//   const generateIntervals = (start, end, date, slotTimerange) => {
//     const out = [];
...
//             times = bookedData.data.appointments.map((appt) =>
...
//           setBookedTimes([...new Set([...times, ...breakTimes])]);
//         } else {
//           setIntervals([]);
//           setBookedTimes([]);
//         }
    ...
    (async () => {
      ...
      try {
        ...
        if (!data.error && data.data?.length) {
          ...
          setBookedTimes([...new Set([...times, ...breaksTemp])]);
        } else {
          setIntervals([]);
          setBookedTimes([]);
          setAvailableSlots([]);
